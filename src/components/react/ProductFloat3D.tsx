    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
          ...
          >
            real ingredients.<br />
            <span style={{ color: 'var(--color-teal)' }}>real flavor.</span>
          </motion.h2>
          <motion.p
          ...
          >
            No petroleum dyes. No artificial flavors. No compromise.
            Just organic candy that parents trust and kids actually want to eat.
          </motion.p>
          <motion.a
            href="/products"
